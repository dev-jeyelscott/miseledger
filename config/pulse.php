...
return [
    ...
    */
    ...
    | console enforces, in every environment (no local-only bypass).
    |
    */
    ...
    */
    ...
    'recorders' => [
        ...
        // Recorders\Servers::class is intentionally omitted: it requires a
        // dedicated `pulse:check` daemon that is not part of the approved
        // POC-V7 process model (web, Horizon, scheduler, AI worker, AI login
        // worker). Coolify process/restart monitoring already covers host
        // health (see docs/deployment.md#observability).
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'groups' => [
                // Group provider API calls by host and generalize resource
                // IDs out of the path so no PayMongo/Stripe identifier is
                // retained in Pulse telemetry.
                '#^https://api\.paymongo\.com/v1/([a-z_]+)/.*$#' => 'api.paymongo.com/v1/\1/*',
                '#^https://api\.stripe\.com/v1/([a-z_]+)/.*$#' => 'api.stripe.com/v1/\1/*',
        ...
        Recorders\SlowRequests::class => [
            ...
            'ignore' => [
                ...
                '#^/'.env('HORIZON_PATH', 'horizon').'#', // Horizon dashboard...
                '#^/telescope#', // Telescope dashboard...
                '#^/billing/webhooks/#', // Signed provider callbacks...
            ],
        ],
