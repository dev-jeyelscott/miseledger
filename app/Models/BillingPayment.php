 ...
 */
#[Fillable(['organization_id', 'billing_invoice_id', 'provider', 'payment_method', 'provider_request_key', 'external_payment_intent_id', 'external_payment_id', 'currency', 'amount', 'status', 'livemode', 'expires_at', 'qr_code_url', 'paid_at', 'receipt_notification_claimed_at', 'receipt_notification_dispatched_at', 'failed_at', 'provider_error_code'])]
